...
todos_collection, part_collection, part_todos_collection = todolist_functions.connect_and_select()
...
todolist_functions.add_todos(todos_collection, todo_list)
...
todolist_functions.add_participants(part_collection, participants)