...
-- Orders 테이블의 CustomerID가 Customers 테이블의 CustomerID와 동일한 값을 가져야 하는 것은 
-- 각 주문이 어떤 고객에게 속하는지를 정확하게 추적하기 위한 필수적인 조건
...
-- LIMIT 0(인덱스 첫번째), 1(행의 개수)을 사용해 첫 번째 결과만 선택하여 가장 많은 주문을 받은 직원에 대한 정보만 선택함 